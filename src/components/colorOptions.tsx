  ...
  return (
    <ul className="flex gap-2">
      <li
        ...
        className={`${
          color === "rgb(255 255 255)" ? "scale-125" : "hover:scale-125"
      ...
      <li
        ...
        className={`${
          color === "rgb(59 130 246)" ? "scale-125" : "hover:scale-125"
      ...
      <li
        ...
        value="rgb(34 197 94)"
        className={`${
          color === "rgb(34 197 94)" ? "scale-125" : "hover:scale-125"
      ...
      <li
        ...
        value="rgb(239 68 68)"
        className={`${
          color === "rgb(239 68 68)" ? "scale-125" : "hover:scale-125"
      ...
      <li
        ...
        className={`${
          color === "rgb(249 115 22)" ? "scale-125" : "hover:scale-125"
      ...
      <li
        ...
        value="rgb(234 179 8)"
        className={`${
          color === "rgb(234 179 8)" ? "scale-125" : "hover:scale-125"
      ...
      <li
        ...
        className={`${
          color === "rgb(168 85 247)" ? "scale-125" : "hover:scale-125"
      ...
      <li
        ...
        className={`${
          color === "rgb(236 72 153)" ? "scale-125" : "hover:scale-125"
